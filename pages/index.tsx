...
import bg from "../public/kelly-sikkema-bE6k8SQT2FQ-unsplash.jpg"
...
export default function Home() {
  ...
  //         href={"/exercise"}
  //       >
  //         <span className="mx-auto">{"Exercise"}</span>
  //         <BsArrowRight className="group-hover:translate-x-2 transition-all ease-in-out duration-500" />
  //       </Link>
  //       </div>
  //     </div>
  ...
  return (
    <>
    <Navbar/>
    <div className="relative flex max-h-[88vh]">
      <Image className="object-cover brightness-50" src={bg} alt="BG"/>
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
        <span className="text-white text-6xl italic tracking-widest">Be The Best You</span> <br />
        <span className="text-white text-6xl italic tracking-widest">Unleash Your Ultimate Fitness Potential</span>
        <Link
          className="group mx-auto md:w-1/2 hover:-skew-x-12  hover:text-white border border-gray-50 text-white font-bold italic transition-all duration-500 overflow-hidden flex items-center gap-x-4 mt-5 tracking-widest text-lg px-7 py-3"
          href={"/exercise"}
        >
          <span className="mx-auto">{"Exercise"}</span>
          <BsArrowRight className="group-hover:translate-x-2 transition-all ease-in-out duration-500" />
